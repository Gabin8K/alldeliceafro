    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
            ...
            <template v-else>
                ...
                <!--                </button>-->
                <Link
                    :href="route('change.locale', [$page.props.currentLocale, 'de'])"
                ...
                <Link
                    :href="route('change.locale', [$page.props.currentLocale, 'en'])"
                ...
                <Link
                    ...
                    class="ms-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                >Log in({{ $page.props.currentLocale }})</Link
                >
                ...
                <Link
                    ...
                    class="ms-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                >Register({{ $t('auth.failed') }})</Link
                >

                <Link
                    v-if="canRegister"
                    :href="route('partner.index', $page.props.currentLocale)"
                    class="ms-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                >Company</Link
                >
            </template>
